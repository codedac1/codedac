...
const APPS = [
  { slug: 'clipboard', name: 'Clipboard+', shots: 3, store: '',
  ...
  { slug: 'autostart', name: 'AutoStart+', shots: 3, store: '',
  ...
  { slug: 'floatcalc', name: 'FloatCalc+', shots: 3, store: '',
  ...
  { slug: 'floatcrypto', name: 'FloatCrypto+', shots: 3, store: '',
    tag: { ko: '플로팅 도구', en: 'Floating' },
  ...
  { slug: 'secretalbum', name: 'SecretAlbum+', shots: 3, store: '',
    tag: { ko: '개인정보', en: 'Privacy' },
